 ...
 *
 * O ramo `messages.upsert` foi removido junto com o iPhone Hunter (decisão do
 * dono, 2026-08-08): ele existia só para capturar anúncios de grupos monitorados
 * e alimentar `WhatsAppGroupMessage`/`IPhoneListing`. O webhook mantém a outra
 * responsabilidade, independente: atualizar o status das mensagens que a loja
 * ENVIA.
 *
 * Payload tipico:
 *   {
