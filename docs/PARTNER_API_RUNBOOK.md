...
- Mesmo fluxo do painel: ver `docs` de reconciliação (cron `reconcile-depix-*`),
  L-BTC da central ([[depix-lbtc-gas-management]] — "insufficient_lbtc"). A API usa
  os MESMOS services, então as mesmas redes de segurança valem.
